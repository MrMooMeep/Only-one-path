from state_class_manager import State
from Title_and_other_UI import Title_UI, Shop_UI

class state_managaer:
    def __init__(self):
        self.state = {
        ...
        self.current_state = 'title' # what current screen to display, since theres a bunch rn, which it should turn on when game is booted
